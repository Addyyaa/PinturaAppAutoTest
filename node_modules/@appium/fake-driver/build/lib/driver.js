...
class FakeDriver extends driver_1.BaseDriver {
    constructor(opts = /** @type {import('@appium/types').InitialOpts} */ ({}), shouldValidateCaps = true) {
    ...
    async createSession(w3cCapabilities1, w3cCapabilities2, w3cCapabilities3, driverData = []) {
        ...
        let [sessionId, caps] = /** @type {[string, FakeDriverCaps]} */ (await super.createSession(w3cCapabilities1, w3cCapabilities2, w3cCapabilities3, driverData));
        this.caps = caps;
